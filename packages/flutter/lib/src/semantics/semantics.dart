...
final class SemanticsLabel {
  ...
  /// The concatenation of labels made of parts supplied using `addPart` and
  /// `addAttributedPart` invocations.
  String get label => _label;

  /// The attributed concatenation of labels made of parts supplied using `addPart`
...
///
/// This builder helps address the complexity of concatenating multiple semantic
/// labels while handling language-specific nuances like RTL vs LTR text direction,
...
final class SemanticsLabelBuilder {
  ...
  ///
  /// The [separator] is used between label parts (defaults to space).
  ...
  /// The separator used between label parts.
  ...
  /// Adds a plain string label part.
  ///
  ...
  /// Adds an attributed string label part.
  ///
  /// If [textDirection] is specified, it will be used for this specific part.
  /// Empty labels are ignored.
  ...
  SemanticsLabel build() {
    ...
    for (int i = 1; i < _parts.length; i++) {
      ...
      // Handle text direction embedding if needed
