...
class AnimatedScrollController extends ScrollController {
  ...
  AnimatedScrollController({
    ...
    if (kDebugMode) {
      print('🎮 AnimatedScrollController: Created with ${animationFactory.runtimeType}');
    }
  }
  ...
  Future<void> animateTo(
    ...
    if (kDebugMode) {
      print('🎮 AnimatedScrollController.animateTo: offset=$offset, duration=$duration, curve=$curve');
    }
    assert(
  ...
  ScrollPosition createScrollPosition(
    ...
    if (kDebugMode) {
      print('🎮 AnimatedScrollController.createScrollPosition: Creating AnimatedScrollPosition');
    }
