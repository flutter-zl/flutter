...
class MaterialScrollBehavior extends ScrollBehavior {
  ...
  ScrollAnimationFactory? get pointerAxisScrollAnimationFactory {
    print('in pointerAxisScrollAnimationFactory 0416');
    // Provide the factory for web and desktop platforms
    if (kIsWeb) { // Or use defaultTargetPlatform checks for desktop OS
      print('in kIsWeb 0416');
      return const ChromiumEaseInOut(); // Replace with your actual factory
    }
    // Otherwise, use the default (null)
    print('in not kIsWeb 0416');
    return super.pointerAxisScrollAnimationFactory;
  }
